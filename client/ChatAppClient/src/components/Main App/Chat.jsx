...
import { Box, Button, TextField, List, ListItemButton, Avatar } from '@mui/material'
                        ...
                        return (
                            ...
                            >
                                <Box
                                    ...
                                    <Avatar sx={{
                                        backgroundColor: userTempName == UserName ? "green" : "rebeccapurple",
                                        marginRight: "1.5rem",

                                    }} >
                                        {userTempName.charAt(0) + userTempName.charAt(userTempName.length - 1)}
                                    </Avatar>
                                    <Box>
                                        {data['message']}
                                    </Box>
